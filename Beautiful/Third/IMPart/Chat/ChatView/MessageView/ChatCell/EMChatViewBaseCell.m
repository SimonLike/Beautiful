...
- (id)initWithMessageModel:(MessageModel *)model reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(_messageModel.isSender?self.bounds.size.width - _headImageView.frame.size.width - HEAD_PADDING*2-NAME_LABEL_WIDTH:_headImageView.frame.origin.x+HEAD_SIZE+HEAD_PADDING, _headImageView.frame.origin.y, NAME_LABEL_WIDTH, NAME_LABEL_HEIGHT)];
...
-(void)layoutSubviews
{
    ...
    [Utils cornerView:self.headImageView withRadius:HEAD_SIZE/2 borderWidth:0 borderColor:[UIColor clearColor]];
    
    _nameLabel.frame = CGRectMake(_messageModel.isSender?self.bounds.size.width - _headImageView.frame.size.width - HEAD_PADDING*2-NAME_LABEL_WIDTH:_headImageView.frame.origin.x+HEAD_SIZE+HEAD_PADDING, _headImageView.frame.origin.y, NAME_LABEL_WIDTH, NAME_LABEL_HEIGHT);
...
- (void)setMessageModel:(MessageModel *)messageModel
{
    ...
    //显示名字
    UIImage *placeholderImage = [UIImage imageNamed:@"defaulthead.png"];
