    ...
    reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        // Initialization code
        _timeLabel = [[UILabel alloc] initWithFrame:CGRectMake(220, 7, 80, 16)];
...
-(void)layoutSubviews{
    ...
    [self.imageView setImageWithURL:_imageURL placeholderImage:[UIImage imageNamed:@"defaulthead.png"]];
