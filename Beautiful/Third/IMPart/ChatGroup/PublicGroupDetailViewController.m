...
{
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:nil message:NSLocalizedString(@"saySomething", @"say somthing") delegate:self cancelButtonTitle:@"取消" otherButtonTitles:NSLocalizedString(@"ok", @"OK"), nil];
