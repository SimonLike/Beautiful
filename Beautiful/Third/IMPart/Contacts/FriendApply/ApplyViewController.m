...
- (void)applyCellAddFriendAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.row < [self.dataSource count]) {
        ...
        if (!error) {
            ...
            [[XQTipInfoView getInstanceWithNib]appear:NSLocalizedString(@"acceptFail", @"accept failure")];
        }
    }
}
...
- (void)applyCellRefuseFriendAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.row < [self.dataSource count]) {
        ...
        if (!error) {
            ...
            [[XQTipInfoView getInstanceWithNib]appear:NSLocalizedString(@"rejectFail", @"reject failure")];
        }
    }
}
