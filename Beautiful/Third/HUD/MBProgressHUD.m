...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
        self.color = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.3];
...
-(void)doAnimation{
    ...
    //设置动画总时间
    ((UIImageView*)self.indicator).animationDuration=1.0;
    //设置重复次数,0表示不重复
    ((UIImageView*)self.indicator).animationRepeatCount=0;
    //开始动画
...
- (void)stopAnimationWithLoadText:(NSString *)text withType:(BOOL)type;
{
    ...
    if(type){
        ...
        [UIView animateWithDuration:0.3f animations:^{
            ...
            [(UIImageView*)self.indicator stopAnimating];
            self.layer.hidden = YES;
            self.alpha = 1;
        }];
    }else{
        [(UIImageView*)self.indicator stopAnimating];
        //[(UIImageView*)self.indicator setImage:[UIImage imageNamed:@"3"]];
    }
...
//        self.indicator = [[UIImageView alloc] initWithFrame:CGRectMake(0,0, 24,24)];
//        ((UIImageView*)self.indicator).animationImages=[NSArray arrayWithObjects: [UIImage imageNamed:@"loading_img_01"],
//                                   [UIImage imageNamed:@"loading_img_02"],
//                                   [UIImage imageNamed:@"loading_img_03"],
//                                   [UIImage imageNamed:@"loading_img_04"],
//                                   [UIImage imageNamed:@"loading_img_05"],
//                                   [UIImage imageNamed:@"loading_img_06"],
//                                   [UIImage imageNamed:@"loading_img_07"],
//                                   [UIImage imageNamed:@"loading_img_08"],
//                                   [UIImage imageNamed:@"loading_img_09"],
//                                   [UIImage imageNamed:@"loading_img_10"],
//                                   [UIImage imageNamed:@"loading_img_11"],
//                                   [UIImage imageNamed:@"loading_img_12"],
//                                   nil ];
...
- (void)layoutSubviews {
    ...
    NSDictionary *attribute =(label.font)?@{NSFontAttributeName:label.font}:nil;
    size = [label.text sizeWithAttributes:attribute];
    
    NSDictionary *attributeDetails =@{NSFontAttributeName: detailsLabel.font};
