...
- (void)setKeyValues:(NSDictionary *)keyValues
{
    ...
    [self enumerateIvarsWithBlock:^(MJIvar *ivar, BOOL *stop) {
        ...
        if(![value isKindOfClass:[NSString class]]&&![value isKindOfClass:[NSArray class]]&&![value isKindOfClass:[NSMutableArray class]]&&![value isKindOfClass:[NSDictionary class]])
            value = [value stringValue];
        if([value isKindOfClass:[NSArray class]]||[value isKindOfClass:[NSMutableArray class]])
        {
            if(((NSArray*)value).count != 0)
            {
                if(![((NSArray*)value)[0] isKindOfClass:[NSDictionary class]]&&![((NSArray*)value)[0] isKindOfClass:[NSMutableDictionary class]])
                    ivar.value = value;
