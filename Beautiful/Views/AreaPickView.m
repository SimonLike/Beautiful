...
- (void)appear{
    ...
    self.frame = CGRectMake(0, SCREEN_HEIGHT-64, SCREEN_WIDTH, 203);
    ...
    pFrame.origin.y = SCREEN_HEIGHT-64-CGRectGetHeight(pFrame);//CGRectGetHeight(self.superview.bounds) - CGRectGetHeight(pFrame);
